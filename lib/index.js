...
class Query {
    ...
    //criar select columns ao invez de selectColumns size...
    ...
    columns(...columns) {
        this.#insertStruct.columns(...columns);
        return this;
    }
    ...
    queryValues(query) {
        this.#insertStruct.select(query);
        return this;
    }
    ...
    #addJoin(type, table, left, operator, right) {
        ...
        /* if (right === undefined && typeof left === 'string' && operator !== undefined) {
            right = operator;
            operator = '=';
        }*/
